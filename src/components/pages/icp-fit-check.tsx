...
import { Upload, Target, FileText, CheckCircle } from "lucide-react";
import { useTheme } from "../../App";
import CsvImportModal from "../company-enrichment/CsvImportModal";

interface ICPFitCheckProps {
  className?: string;
}

const ICPFitCheck = ({ className = "" }: ICPFitCheckProps) => {
      ...
      <div className="flex">
        ...
        <div className="flex-1 px-6 py-12">
          ...
          <div className="text-center mb-12">
            ...
            >
              ICP Fit Check – Reason + Scoring
            </h1>
            <p
              className={`text-lg ${isDark ? "text-gray-300" : "text-gray-600"} max-w-2xl mx-auto`}
            >
              Analyze your prospects against your Ideal Customer Profile with
              AI-powered scoring and detailed reasoning. Upload your CSV file to
              get comprehensive ICP fit analysis.
            </p>
          </div>
            ...
            >
              <CardContent className="p-12 text-center">
                <div className="mb-8">
                  ...
                  >
                    Ready to Analyze Your ICP Fit?
                  </h2>
                  <p
                    className={`text-lg ${isDark ? "text-gray-300" : "text-gray-600"} mb-8`}
                  >
                    Upload your CSV file with company data and get detailed ICP
                    fit analysis including scoring, reasoning, and
                    recommendations for each prospect.
                  </p>
                </div>

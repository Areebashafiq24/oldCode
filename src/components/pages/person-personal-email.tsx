...
import { Upload, Mail, FileText, CheckCircle } from "lucide-react";
import { useTheme } from "../../App";
import CsvImportModal from "../company-enrichment/CsvImportModal";

interface PersonPersonalEmailProps {
  className?: string;
}

const PersonPersonalEmail = ({ className = "" }: PersonPersonalEmailProps) => {
    ...
    >
      <div className="px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          >
            Find personal email addresses for your prospects with AI-powered
            search. Upload your CSV file with person names and company
            information to get accurate personal email addresses.
          </p>
        </div>
      ...
      <CsvImportModal
        ...
        apiEndpoint="/api/person-mobile-phone"
      />
    </div>
  );
};

export default PersonPersonalEmail;
